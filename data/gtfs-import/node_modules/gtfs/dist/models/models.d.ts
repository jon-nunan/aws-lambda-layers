...
declare const serviceAlertTargets: {
    filenameBase: string;
    extension: string;
    schema: ({
        name: string;
...
export { agency, areas, attributions, boardAlight, bookingRules, calendar, calendarAttributes, calendarDates, deadheadTimes, deadheads, directions, fareAttributes, fareLegRules, fareMedia, fareProducts, fareRules, fareTransferRules, feedInfo, frequencies, levels, locationGroupStops, locationGroups, locations, networks, opsLocations, pathways, rideFeedInfo, riderTrip, ridership, routeAttributes, routeNetworks, routes, runEvents, runsPieces, serviceAlertTargets, serviceAlerts, shapes, stopAreas, stopAttributes, stopTimeUpdates, stopTimes, stops, timeframes, timetableNotes, timetableNotesReferences, timetablePages, timetableStopOrder, timetables, transfers, translations, tripCapacity, tripUpdates, trips, tripsDatedVehicleJourney, vehiclePositions };
